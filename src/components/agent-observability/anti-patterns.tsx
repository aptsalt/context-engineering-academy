...
import { antiPatterns } from "@/lib/agent-observability-data";
    ...
    <div className="space-y-8">
      <div className="prose prose-invert max-w-none">
        <p className="text-lg leading-relaxed text-foreground/90">
          ...
          what to do. These are the most common observability anti-patterns in
          AI agent systems — each one has been observed in production systems
          and leads to predictable failure modes.
        </p>
      </div>
