...
import { ragAntiPatterns } from "@/lib/agentic-rag-data";
...
export function RagAntiPatterns() {
  return (
    <div className="space-y-8">
      <div className="prose prose-invert max-w-none">
        <p className="text-lg leading-relaxed text-foreground/90">
          Knowing what <strong>not</strong> to do is as important as knowing
          what to do. These are the most common RAG failure modes, distilled
          from production systems, research papers, and the RAG community.
          Each pattern has been observed to cause significant quality
