    ...
    <div className="space-y-8">
      <div className="prose prose-invert max-w-none">
        <p className="text-lg leading-relaxed text-foreground/90">
          ...
          Microsoft Research, and the broader AI engineering community.
        </p>
      </div>
      ...
      <Card className="bg-gradient-to-br from-primary/5 to-transparent border-primary/20">
        <CardContent className="pt-6">
          ...
          <p className="text-sm text-foreground/90 leading-relaxed">
            Find the <strong>smallest set of high-signal tokens</strong> that
            maximize the likelihood of your desired outcome. Whether you&apos;re
            implementing compaction, designing tools, or enabling agents to
            explore — every decision should optimize for this principle.
          </p>
