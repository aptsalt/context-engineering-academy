    ...
    <div className="space-y-8">
      <div className="prose prose-invert max-w-none">
        <p className="text-lg leading-relaxed text-foreground/90">
          Essential reading, research papers, repositories, and tools for
      ...
      <Card className="bg-card/50 border-dashed">
        <CardContent className="pt-6">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            <strong>Context Engineering: The Art and Science of Shaping
            Context-Aware AI Systems</strong> by Boni Garcia — to be published
            by Manning in 2026. The first dedicated book on context engineering.
          </p>
        </CardContent>
      </Card>
    </div>
