...
import { antiPatterns } from "@/lib/tool-use-mcp-data";
...
export function ToolAntiPatterns() {
  return (
    <div className="space-y-8">
      <div className="prose prose-invert max-w-none">
        <p className="text-lg leading-relaxed text-foreground/90">
          Knowing what <strong>not</strong> to do is as important as knowing
          what to do. These are the most common failure modes in tool-using
          AI systems, drawn from production experience and research on function
          calling accuracy.
        </p>
      </div>
